...
- **[Conveyor CI](https://conveyor.open.ug/)**: A lightweight headless, cloud-native CI/CD orchestration engine for building CI/CD systems with ease.
- **[Crane Cloud Mira](https://github.com/crane-cloud/mira-new)**: Crane Cloud Mira is a software platform that automatically turns source code into OCI container images.
